...
/*   Updated: 2024/06/25 16:46:30 by momrane          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	mlx_hook((void *)env.win_ptr, 2, 1L << 0, ft_key_hook, &env);// key release
// 	mlx_hook((void *)env.win_ptr, 3, 1L << 1, ft_key_hook, &env);// key press
...
int	main(int ac, char **av)
{
	...
	ft_load_images(&env);
	// mlx_hook((void *)env.win_ptr, 2, 1L << 0, ft_key_hook, &env);// key release
	mlx_hook((void *)env.win_ptr, 2, KeyPressMask, ft_key_pressed, &env);// key release
	mlx_hook((void *)env.win_ptr, 3, KeyReleaseMask, ft_key_released, &env);// key press
